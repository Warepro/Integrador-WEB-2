...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Inicio</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Sobre</strong></div>
        </div>
      </div>
    </div>  
          ...
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                ...
                <a href="https://youtu.be/i1ynt_YU3-8" class="play-button popup-vimeo"><span class="ion-md-play"></span></a>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Paulo Bto</h3>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  ...
                  <h3 class="block-38-heading h4">Emilio Milo</h3>
