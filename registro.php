...
<html lang="en">
  <head>
    <title>AlpaxNatural-Prueba</title>
    <meta charset="utf-8">
    ...
    <body>  
        ...
        <div>
            <h4 class="text-center">Registrese aquí</h4>
        </div>
        <div class="col-md-6 m-auto">  
            <form action="recibir.php" method="post">

                <div class="bg-light  p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                    <label for="c_subject" class="text-black">Usuario <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="c_subject" name="usuario">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-12">
                    <label for="c_subject" class="text-black">Contraseña <span class="text-danger">*</span></label>
                    <input type="password" class="form-control" id="c_subject" name="contra">
                    </div>
                </div>

                <div class="form-group row">
                    <div class="col-lg-12">
                    <input type="submit" class="btn btn-warning" btn-lg btn-block" name="enviar" value="Registrarse">
                    </div>
                </div>
                </div>
            </form>
