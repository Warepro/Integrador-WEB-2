                ...
                <div class="d-flex">
                  <div class="dropdown mr-1 ml-md-auto">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                      ...
                      <a class="dropdown-item" href="#">Para la salud</a>
                      <a class="dropdown-item" href="#">Para el cuerpo</a>
                    </div>
                  </div>
                  <div class="btn-group">
                    <button type="button" class="btn btn-secondary btn-sm dropdown-toggle" id="dropdownMenuReference" data-toggle="dropdown">Filtrar por</button>
            ...
            <div class="row mb-5">
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  ...
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.php">Camote Silvestre</a></h3>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  ...
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.php">Clavo de olor</a></h3>
                    <p class="mb-0">Encuentra lo indicado para ti</p>
                    <p class="text-primary font-weight-bold">$50</p>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  ...
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.php">Calcio Enriquecido</a></h3>
                    <p class="mb-0">Encuentra lo indicado para ti</p>
                    <p class="text-primary font-weight-bold">$50</p>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  ...
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.php">Jalea Real</a></h3>
                    <p class="mb-0">Encuentra lo indicado para ti</p>
                    <p class="text-primary font-weight-bold">$50</p>
                  </div>
                </div>
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  ...
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.php">Clavo de olorr</a></h3>
                    <p class="mb-0">Encuentra lo indicado para ti</p>
                    <p class="text-primary font-weight-bold">$50</p>
                  </div>
                </div>
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                <li class="mb-1"><a href="#" class="d-flex"><span>Otras</span> <span class="text-black ml-auto">(2,220)</span></a></li>
                <li class="mb-1"><a href="#" class="d-flex"><span>Para la suld</span> <span class="text-black ml-auto">(2,550)</span></a></li>
                <li class="mb-1"><a href="#" class="d-flex"><span>Para el cuerpo</span> <span class="text-black ml-auto">(2,124)</span></a></li>
              </ul>
            </div>
            ...
            <div class="border p-4 rounded mb-4">
              ...
              <div class="mb-4">
                <h3 class="mb-3 h6 text-uppercase text-black d-block">Empaque</h3>
